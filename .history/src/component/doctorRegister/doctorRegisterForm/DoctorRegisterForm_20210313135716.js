...
const generateOtp=(event)=>{
    ...
    <Form.Group>
    <Button positive onClick={event=>generateOtp(event)} className="doctorRegisterForm__button">Generate OTP</Button>
    <Form.Input label='Enter OTP' placeholder='hospital'   />
    </Form.Group>
    <Form.Group className="doctorRegisterForm__buttonPosition">
    <Button positive style={{marginRight:'4rem'}}>Submit</Button>
    <Button type="submit" style={{marginBottom:'2rem'}}>Cancel</Button>
    </Form.Group>
  </Form>
        </div>
    )
