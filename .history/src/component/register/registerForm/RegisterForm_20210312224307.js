    ...
    return (
        <div className="registerform">
            ...
            <Form onSubmit={formSubmit}>
                ...
                />
                <button type='submit' disabled={loading} className={loading ? 'loading registerform__button' : "registerform__button"} >Submit <Icon name="arrow right" /> </button>
            </Form>
            <div className="registerform__link">Already a user? Link{/*<Link to="/login">  Login</Link>*/}</div>
